...
const getBoard = (id: string | undefined): Promise<Board | undefined> => boardsRepo.getById(id);
...
const updateBoard = (id: string | undefined, body: IBoardRequest): Promise<Board | undefined> => boardsRepo.updateBoard(id, body);

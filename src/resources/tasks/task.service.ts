...
const getTask = (boardId: string | undefined, id: string | undefined): Promise<Task | undefined> => tasksRepo.getById(boardId, id);
...
const updateTask = (boardId: string | undefined, id: string | undefined, body: ITaskRequest): Promise<Task | undefined> =>
